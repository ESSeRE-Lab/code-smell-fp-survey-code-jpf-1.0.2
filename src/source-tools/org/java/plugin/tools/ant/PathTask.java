 ...
 * declarations.
 * 
 * @version $Id: PathTask.java,v 1.3 2007/03/01 19:10:57 ddimon Exp $
 */
public class PathTask extends BaseJpfTask {
    ...
    public void execute() throws BuildException {
        ...
        Set ids = collectTargetIds(); //<String>
        if (ids.isEmpty()) {
            throw new BuildException(
        ...
        initRegistry(true);
        Set processedIds = new HashSet(); //<String>
    ...
    private void processDescriptor(final Set result, final Set processedIds,
            final PluginDescriptor descr, final boolean includePrivate) {
