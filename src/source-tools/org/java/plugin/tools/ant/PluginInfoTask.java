 ...
 * 
 * @version $Id: PluginInfoTask.java,v 1.4 2007/02/10 17:20:24 ddimon Exp $
 */
public class PluginInfoTask extends Task {
     ...
     *                     fragment version in
     * 
     * @see org.java.plugin.registry.PluginRegistry.ManifestInfo#getVersion()
     */
     ...
     *                     fragment vendor in
     * 
     * @see org.java.plugin.registry.PluginRegistry.ManifestInfo#getVendor()
     */
     ...
     * 
     * @see org.java.plugin.registry.PluginRegistry.ManifestInfo#getPluginId()
     */
     ...
     * 
     * @see org.java.plugin.registry.PluginRegistry.ManifestInfo#getPluginVersion()
     */
     ...
     *                     matching rule in
     * 
     * @see org.java.plugin.registry.PluginRegistry.ManifestInfo#getMatchingRule()
     */
    ...
    public void execute() throws BuildException {
        ...
        if (propertyMatchingRule != null) {
            String value = manifestInfo.getMatchingRule();
