...
/**
 * @version $Id: MockParameter.java,v 1.3 2006/09/14 18:15:45 ddimon Exp $
 */
public class MockParameter extends MockPluginElement implements Parameter {
    private Extension declaringExtension;
    private ParameterDefinition definition;
    private Parameter superParameter;
    private String rawValue;
    private Object typedValue;
    private LinkedList subParameters = new LinkedList();
