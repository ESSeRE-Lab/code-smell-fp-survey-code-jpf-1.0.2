...
/**
 * @version $Id: MockPluginAttribute.java,v 1.2 2006/09/14 18:10:39 ddimon Exp $
 */
public class MockPluginAttribute extends MockPluginElement implements
        PluginAttribute {
    private LinkedList subAttributes = new LinkedList();
