...
/**
 * Factory class to help creating base Framework objects: plug-in registry,
 * path resolver and plug-in manager.
 * 
 * @version $Id: ObjectFactory.java,v 1.10 2006/08/26 15:14:10 ddimon Exp $
 */
public abstract class ObjectFactory {
    ...
    private static Class loadClass(final ClassLoader cl, final String className)
    ...
    /**
     * Creates new instance of path resolver implementation class using
     * standard discovery algorithm to determine which resolver implementation
     * class should be instantiated.
