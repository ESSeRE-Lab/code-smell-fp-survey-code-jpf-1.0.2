...
/**
 * @version $Id: LibraryImpl.java,v 1.4 2006/06/05 18:16:43 ddimon Exp $
 */
class LibraryImpl extends PluginElementImpl implements Library {
    ...
    LibraryImpl(final PluginDescriptorImpl descr,
        ...
        exports = new ArrayList(model.getExports().size());
