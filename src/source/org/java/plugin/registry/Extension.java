 ...
 * </p>
 *
 * @version $Id: Extension.java,v 1.2 2005/12/10 13:15:28 ddimon Exp $
 */
public interface Extension extends UniqueIdentity, PluginElement {
    /**
     ...
     */
    Collection getParameters(String id);
    ...
    interface Parameter extends PluginElement {
         ...
         */
        Collection getSubParameters(String id);
