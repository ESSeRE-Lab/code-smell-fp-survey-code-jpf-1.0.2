 ...
 * </p>
 * 
 * @version $Id: PluginPrerequisite.java,v 1.4 2006/06/04 12:50:55 ddimon Exp $
 */
public interface PluginPrerequisite extends UniqueIdentity, PluginElement {
    /**
     * Version identifier matching mode.
     */
    String MATCH_EQUAL = "equal"; //$NON-NLS-1$
    
    /**
     * Version identifier matching mode.
     */
    String MATCH_EQUIVALENT = "equivalent"; //$NON-NLS-1$
    
    /**
     * Version identifier matching mode.
     */
    String MATCH_COMPATIBLE = "compatible"; //$NON-NLS-1$
    
    /**
     * Version identifier matching mode.
     */
    String MATCH_GREATER_OR_EQUAL = "greater-or-equal"; //$NON-NLS-1$
