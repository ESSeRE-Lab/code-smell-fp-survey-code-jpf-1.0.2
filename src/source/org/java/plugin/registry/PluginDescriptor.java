 ...
 * @version $Id: PluginDescriptor.java,v 1.5 2007/01/05 14:05:23 ddimon Exp $
 */
public interface PluginDescriptor extends UniqueIdentity, Documentable {
    /**
     ...
     */
    Collection getAttributes(String id);
