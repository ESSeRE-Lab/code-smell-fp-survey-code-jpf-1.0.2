 ...
 * @version $Id: PluginAttribute.java,v 1.1 2005/07/20 18:43:46 ddimon Exp $
 */
public interface PluginAttribute extends PluginElement {
    /**
     ...
     */
    Collection getSubAttributes(String id);
