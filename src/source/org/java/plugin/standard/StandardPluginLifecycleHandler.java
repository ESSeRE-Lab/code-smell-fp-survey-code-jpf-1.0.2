 ...
 * </dl>
 * </p>
 * @version $Id: StandardPluginLifecycleHandler.java,v 1.7 2007/04/07 12:43:21 ddimon Exp $
 */
public class StandardPluginLifecycleHandler extends PluginLifecycleHandler {
    ...
    protected org.java.plugin.PluginClassLoader createPluginClassLoader(
        ...
        StandardPluginClassLoader result =
            (StandardPluginClassLoader) AccessController.doPrivileged(
