 ...
 * procedure.
 * @version $Id: StandardPathResolver.java,v 1.16 2007/01/05 13:22:09 ddimon Exp $
 */
public class StandardPathResolver implements PathResolver {
    protected Log log = LogFactory.getLog(getClass());
    
    private Map urlMap =
        new HashMap(); // <pluginId or fragmentId, home URL>
    ...
    public void registerContext(final Identity idt, final URL url) {
        ...
        URL oldUrl = (URL) urlMap.put(idt.getId(), url);
        if (oldUrl != null) {
