 ...
 * manually.
 * </p>
 * @version $Id: DefaultPluginsCollector.java,v 1.6 2006/08/19 17:40:13 ddimon Exp $
 */
public class DefaultPluginsCollector implements PluginsCollector {
    ...
    public Collection collectPluginLocations() {
        ...
        for (Iterator it = descriptors.iterator(); it.hasNext();) {
            processDescriptor((URL) it.next(), result);
        }
        return result;
    }

    protected void processFolder(final File folder, final List result) {
    ...
    protected void processFile(final File file, final List result) {
    ...
    private void processDescriptor(final URL url, final List result) {
    ...
    private final class LocationsDescriptorHandler extends DefaultHandler {
        ...
        LocationsDescriptorHandler(final List result) {
            resultData = result;
        }
